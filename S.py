...
#==============================================================================#
                    ...
                    try:
                        ...
                        try:
                            line.sendContact(group, "u669aa92773d33c22420105d4546fccdd',")
                        except:
                            line.sendContact(group, "u669aa92773d33c22420105d4546fccdd',")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("SELFBOT-BY:😈ຜู้คุມกาມlทW😈",mi_d)
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("SELFBOT-BY:😈ຜู้คุມกาມlทW😈", mi_d)
                    line.sendText(msg.to,"WELCOME TO ROOM SELFBOT-BY:😈ຜู้คุມกาມlทW😈")
