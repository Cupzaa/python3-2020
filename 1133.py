...
RfuBot = ["u669aa92773d33c22420105d4546fccdd",lineMID]
Family = ['u669aa92773d33c22420105d4546fccdd',lineMID]
admin = ["u669aa92773d33c22420105d4546fccdd",lineMID]
adminMID = "u669aa92773d33c22420105d4546fccdd",lineMID
...
with open("read.json", "r", encoding="utf_8_sig") as f:
...
def dt_to_str(dt):
    ...
    return dt.strftime('%02d วัน %02d ชั่วโมง %02d นาที %02d วินาที' )#% days, hours, mins, secs)
...
╠❂͜͡☬➣😈 คำสั่งเชลบอท  😈
╠═════════════════
╠❂͜͡☬➣คำสั่ง ➣คำสั่งเซลบอท
╠❂͜͡☬➣คำสั่ง1 ➣คำสั่งในกลุ่ม
╠❂͜͡☬➣คำสั่ง2 ➣คำสั่งตั้งค่า
╠❂͜͡☬➣คำสั่ง3 ➣คำสั่งโซเชียล
╠❂͜͡☬➣คำสั่ง4 ➣คำสั่งเปิด/ปิด
╠❂͜͡☬➣คำสั่ง5 ➣คำสั่งแปลภาษา
╠❂͜͡☬➣คำสั่ง6 ➣คำสั่งคิกเกอร์
╠❂͜͡☬➣คำสั่ง7 ➣คำสั่งภาษา
╠❂͜͡☬➣คำสั่ง8 ➣สิริ
╠❂͜͡☬➣คำสั่ง9 ➣Menu
╚═════════════════
╔═════════════════
╠❂͜͡☬➣ 😈 โหมดคำสั่ง 😈
╠═════════════════
╠❂͜͡☬➣คำสั่ง1 [คำสั่งเซลบอท]
╠❂͜͡☬➣คำสั่ง2 [คำสั่งในกลุ่ม]
╠❂͜͡☬➣คำสั่ง3 [คำสั่งตั้งค่า]
╠❂͜͡☬➣คำสั่ง4 [คำสั่งโซเชล]
╠❂͜͡☬➣คำสั่ง5 [คำสั่งพูดMp3]
╠❂͜͡☬➣คำสั่ง6 [คำสั่งแปลภาษา]
╠═════════════════
║   😈ຜู้คุມกาມlทW😈
╚═════════════════
╔═════════════════
...
╚═════════════════
 ...
 ให้ใส่ . (จุด) นำหน้าคำสั่งเวลาใช้
 """
    return myHelp
...
╚═════════════════
*หมายเหตุ*  คำสั่งที่เป็นภาษาไทย
 ให้ใส่ . (จุด) นำหน้าคำสั่งเวลาใช้ด้วยเด้อ
 """
    return socMedia
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     try:
                                         ...
                                         line.sendText(msg.to,"😧ตรวจพบข้อผิดพลาดที่ไม่ทราบสาเหตุ😩\nอาจเป็นได้ว่าบัญชีของคุณถูกแบนเชิญ😨")
                                         settings["winvite"] = False
                                         break
        if op.type == 25:
            msg = op.message
            ...
            if msg.contentType == 13:
               if settings["wblack"] == True:
                   ...
                   if msg.contentMetadata["mid"] in settings["commentBlack"]:
                        ...
                        settings["dblack"] = False
                        line.sendText(msg.to," ไม่มีรายชื่ออะไรในบัญชีดำครับ ")
...
#😈ຜู้คุມกาມlทW😈 
                    ...
                    line.sendMessage(to, " เปิดใช้งานการเพิ่มเพื่อนอัตโนมัติแล้วครับ ")
                elif text.lower() == '.เปิดบล็อค':
                    settings["autoBlock"] = True
                    settings["autoAdd"] = False
                    RfuProtect["autoBlock"] == True
                    RfuProtect["autoAdd"] == False
                    line.sendMessage(to, "เปิดใช้งานล็อคอัตโนมัติ.")
                elif text.lower() == '.ปิดแอด':
                    settings["autoAdd"] = False
                    RfuProtect["autoAdd"] == False
                    line.sendMessage(to, "ปิดใช้งานการเพิ่มเพื่อนอัตโนมัติแล้วครับ.")
                elif text.lower() == '.ปิดบล็อค':
                    settings["autoBlock"] = False
                    RfuProtect["autoBlock"] == False
                    line.sendMessage(to, "ปิดใช้งานล็อคอัตโนมัติ.")
                elif text.lower() == '.เปิดเข้า':
                    settings["autoJoin"] = True
                    line.sendMessage(to, "เปิดใช้งานการเข้าร่วมอัตโนมัติ.")
                elif text.lower() == '.ปิดเข้า':
                    settings["autoJoin"] = False
                    line.sendMessage(to, "ปิดใช้งานการเข้าร่วมอัตโนมัติ.")
                    ...
                    try:
                        ...
                        if strnum == "off":
                                ...
                                if settings["lang"] == "JP":
                                    ...
                                    line.sendText(msg.to,"关了邀请拒绝。要时开请指定人数发送\nคำเชิญถูกปฏิเสธ หากคุณต้องการเปิดโปรดส่งจำนวนคนที่ระบุ")
                        else:
                                num =  int(strnum)
                    ...
                    line.sendMessage(to, "เปิดใช้งานข้อความตอบกลับอัตโนมัติ.")
                elif text.lower() == '.ปิดอ่าน':
                    settings["autoRead"] = False
                    line.sendMessage(to, "ปิดใช้งานข้อความตอบกลับอัตโนมัติ.")
                elif text.lower() == '.เปิดติ๊ก':
                    settings["checkSticker"] = True
                    line.sendMessage(to, "ตรวจสอบสติกเกอร์ที่เปิดใช้งาน.")
                elif text.lower() == '.ปิดติ๊ก':
                    settings["checkSticker"] = False
                    line.sendMessage(to, "ตรวจสอบสติกเกอร์ที่ปิดใช้งาน.")
                elif text.lower() == '.เปิดมุด':
                    settings["autoJoinTicket"] = True
                    line.sendMessage(to, "เปิดใช้งานการเข้าร่วมอัตโนมัติด้วยตั๋ว.")
                elif text.lower() == '.ปิดมุด':
                    settings["autoJoinTicket"] = False
                    line.sendMessage(to, "ปิดใช้งานการเข้าร่วมอัตโนมัติด้วยตั๋ว.")
...
#==============================================================================#
                    ...
                    line.sendMentionFooter(to, '「 ผู้สร้างบอท  」\n', sender, "line.me/R/ti/p/~yim_cjs", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'line.me/R/ti/p/~yim_cjs', 'type': 'mt', 'subText': "😈ຜู้คุມกาມlทW😈", 'a-installUrl': 'line.me/R/ti/p/~yim_cjs', 'a-installUrl': 'line.me/R/ti/p/~yim_cjs', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'line.me/R/ti/p/~yim_cjs', 'i-linkUri': 'line.me/R/ti/p/~yim_cjs', 'text': 'Khie', 'linkUri': 'line.me/R/ti/p/~yim_cjs'}, contentType=19)
                elif text.lower() == ".คท":
                    userid = "line.me/R/ti/p/~" + line.profile.userid
                    ...
                    line.sendMusic(to, line.getContact(sender).displayName, "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, str(userid), "👉 BOT เฮียยิ้ม", line.getContact(sender).displayName)
                    ...
                    line.sendMessage(msg.to,"[ 🤸ไอดี🤸]\n" +  lineMID)
                elif text.lower() == '.ชื่อ':
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"[  ชื่อที่แสดง ]\n" + me.displayName)
                elif text.lower() == '.ตัส':
                    me = line.getContact(lineMID)
                    line.sendMessage(msg.to,"[  ข้อความสถานะ  ]\n" + me.statusMessage)
                    ...
                    if 'MENTION' in list(msg.contentMetadata.keys())!= None:
                        ...
                        for ls in lists:
                            contact = line.getContact(ls)
                            line.sendMessage(msg.to, "[  ข้อความแสดงสถานะ  ]\n{}" + contact.statusMessage)
                    ...
                    if msg._from in admin:
                        ...
                        u.write(a)
                        u.close()
                        line.sendText(msg.to, "การสำรองข้อมูลถูกเปิดใช้งาน✔️")
                        print (wek)
                        print (a)
                        print (r)
                        print (i)
                    ...
                    for target in targets:
                        try:
                            ...
                            line.sendMessage(msg.to, "ดำเนินการสำเร็จสิ้น...")
                        #---------------------------------------
...
#==============================================================================#
                    ...
                    for target in targets:
                        try:
                            ...
                            line.sendMessage(msg.to,"เลียนแบบได้รับการเพิ่มเป็น")
                            break
                        except:
                            line.sendMessage(msg.to,"เพิ่มเป้าหมายล้มเหลว !")
                            break
                    ...
                    for target in targets:
                        try:
                            ...
                            line.sendMessage(msg.to,"การเลียนแบบการลบสำเร็จ...")
                            break
                        except:
                            line.sendMessage(msg.to,"ลบเป้าหมายล้มเหลว !")
                            break
                elif text.lower() == 'mimiclist':
                    if settings["mimic"]["target"] == {}:
                        line.sendMessage(msg.to,"ไม่มีเป้าหมาย")
                    else:
                        mc = "╔══[ รายการเลียนแบบ ]"
                    ...
                    if mic == "on":
                        if settings["mimic"]["status"] == False:
                            ...
                            line.sendMessage(msg.to,"เปิดใช้งานการเลียนแบบ.")
                    elif mic == "off":
                        if settings["mimic"]["status"] == True:
                            settings["mimic"]["status"] = False
                            line.sendMessage(msg.to,"เลียนแบบปิดการใช้งาน.")
                    ...
                    if txt[1] == "on":
                        if jmlh <= 100000:
                           ...
                           line.sendMessage(msg.to, "ไม่อยู่ในขอบเขต!")
                    elif txt[1] == "off":
                        if jmlh <= 100000:
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "☝ คนนี้แหล่ะเจ้าของกลุ่มนี้")
                    ...
                    if msg.toType == 2:
                        group = line.getGroup(to)
                        if group.preventedJoinByTicket == False:
                            line.sendMessage(to, "เปิดลิ้งเรียบร้อย✔️")
                        else:
                    ...
                    if 'MENTION' in msg.contentMetadata.keys() != None:
                        ...
                        if ngroup == "":
                             line.sendMessage(to, "ไม่พบกลุ่มที่ค้นหา")
                        else:
                	...
                	if msg.toType == 2:                
                           ...
                           if settings["lang"] == "JP":
                               ...
                               line.sendMessage(receiver, "พิมพ์คำเชิญแอดมินกลุ่ม")
                           else:
                               line.inviteIntoGroup(receiver,[gcmid])
                    ...
                    if True:                                      
                        line.sendMessage(to,"line.me/R/ti/p/~" + id)
                    ...
                    line.sendMessage(to, "ทำการบล็อคไอดีนั้นแล้ว✔️")
                    ...
                    try:
                        ...
                        try:
                            line.sendContact(group, "u085311ecd9e3e3d74ae4c9f5437cbcb5',")
                        except:
                            line.sendContact(group, "u085311ecd9e3e3d74ae4c9f5437cbcb5',")
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        line.sendText(msg.to,"ไม่พบที่ติดต่อ")
                    else:
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("😈ຜู้คุມกาມlทW😈",mi_d)
                               line.sendText(msg.to,"🏂⛷️[จะออกไปแตะขอบฟ้า]")
                               line.createGroup("😈ຜู้คุມกาມlทW😈",mi_d)
                               line.sendText(msg.to,"🏂⛷️[จะออกไปแตะขอบฟ้า]")
                               line.sendText(msg.to,"ดำเนินการเรียบร้อย")
                            except:
                                pass
                    print ("[Command]covergroup]")
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           ...
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           line.sendText(g.mid,"😈ຜู้คุມกาມlทW😈")
                           line.sendText(msg.to, "Done\n ✔️ดำเนินการเกรียนเรียบร้อยแล้ว")
                           print ("[ Spam PRO-SPEEDXP ]")
                elif ".ดึงห้อง" in msg.text:
                    thisgroup = line.getGroups([msg.to])
                    Mids = [contact.mid for contact in thisgroup[0].members]
                    mi_d = Mids[:33]
                    line.createGroup("PRO", mi_d)
                    line.sendText(msg.to,"😈WELCOME TO ROOM PRO-SPEEDXP😈")
 ...
 #                   kc.sendMessage(to, "Ping")      
  #                  ke.sendMessage(to, "Ping")         
                        ...
                        if 'MENTION' in msg.contentMetadata.keys()!= None:
                            ...
                            for mention in mentionees:
                                if mention["M"] not in lists:
                                    lists.append(mention["M"])
                            for receiver in lists:
                                line.sendMessage(receiver, text=None, contentMetadata={'mid': ''}, contentType=13)
                    ...
                    if GACReq.responseNum == 0:
                        if msg.toType != 0:
                                line.sendText(msg.to,"ส่ง SMS สำเร็จแล้ว ✔️(｀・ω・´)")
                        else:
                                line.sendText(msg._from,"ส่ง SMS สำเร็จแล้ว ✔️(｀・ω・´)")
                    ...
                    if spl[0] == "":
                        try:
                            ...
                            line.sendText(msg.to,"ตรวจพบข้อผิดพลาด (เหตุผล \""+e.reason+"\")")
...
#==============================================================================#
                    ...
                    readTime = hasil + ", " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y') + "\nJam : [ "+ timeNow.strftime('%H  ชั่วโมง :%M นาที :%S วินาที') + " ] "
                    ...
                    if msg.to not in read['readPoint']:
                        line.sendMessage(msg.to,"ที่ซุ่มซ่อนปิดใช้งาน")
                    else:
                        try:
                            del read['readPoint'][msg.to]
                            del read['readMember'][msg.to]
                            del read['readTime'][msg.to]
                              ...
                              pass
                        line.sendMessage(msg.to, "ลบจุดอ่าน:\n" + readTime)
                    ...
                    if msg.to in read["readPoint"]:
                        try:
                            ...
                            pass
                        line.sendMessage(msg.to, "รีเซ็ตจุดอ่าน:\n" + readTime)
                    else:
                        line.sendMessage(msg.to, "คุณยังไม่ได้เปิดใช้งานสิ่งที่จะรีเซ็ต?")
                    ...
                    if receiver in read['readPoint']:
                        ...
                        line.sendMessage(receiver,"ยังไม่ได้ตั้งค่า Lurking\n หรือการจับเวลาอ่าน ✔️")
#==============================================================================#
...
#                               aditmadzs.sendMessage(msg.to,"KI\n"+ki.authToken)
                    ...
                    for i in gid:
                        line.sendText(i, " [ ข้อความอัตโนมัติ ] \n\n\n"+bc+"\n\n\n🥰หากรบกวนต้องขออภัยครับ🥰")
                    
                elif ".ประกาศแชท " in msg.text:
                    bc = msg.text.replace(".ประกาศแชท ","")
                    gid = line.getAllContactIds()
                    for i in gid:
                        line.sendText(i,"   [ ข้อความประกาศแชท อัตโนมัติ ] \n\n"+bc+"\n\n! หากรบกวนขออภัยด้วยครับ !")
                    ...
                    day = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday","Friday", "Saturday"]
                    hari = ["วันอาทิตย์", "วันจันทร์", "วันอังคาร", "วันพุธ", "วันพฤหัสบดี", "วันศุกร์", "วันเสาร์"]
                    bulan = ["มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน", "พฤษภาคม", "มิถุนายนi", "กรกฎาคมi", "สิงหาคม", "กันยายน", "ตุลาคม", "พฤศจิกายน", "ธันวาคม"]
                    hr = timeNow.strftime("%A")
                    bln = timeNow.strftime("%m")
                    for i in range(len(day)):
                        if hr == day[i]: hasil = hari[i]
                    for k in range(0, len(bulan)):
                        if bln == str(k): bln = bulan[k-1]
                    readTime = "🌴 ปฏิทินโดย [ เฮียยิ้มงัย จะคัยละ ] 🌴\n🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸🌿" + "\n🍁" + hasil + "\n🍁 ที่ " + timeNow.strftime('%d ') + " - " + bln + " - " + timeNow.strftime('%Y')  + "\n🍁 เวลา : [ " + timeNow.strftime('%H ชั่วโมง  : %M  นาที : %S วินาที'  ) + " ]" + "🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸🌿"
                    ...
                    line.sendMessage(msg.to,"เปิดระบบแสกนคนแอบอ่านอัตโนมัติ✔️")
                    ...
                    line.sendMessage(receiver, 'หยุดการทำงานเซลบอทเรียบร้อย✔️')
                    print ("Selfbot Off")
                    exit(1)
                        ...
                        if msg._from in lineMID:
                            try:
                                line.removeAllMessages(op.param2)
                                line.sendMessage(msg.to,"ลบทุกการแชทเรียบร้อย✔️")
                            except:
                                pass
                                print ("ลบแชท")
                	...
                	if msg.toType == 2:
                         ...
                         line.sendMessage(receiver,"╔════════════════┓\n╠❂ line://ti/g/" + gurl + "\n╠\n╠❂ ก็อปปี้ หรือ กดส่งต่อ ลิ้งค์ห้องได้ตามนี้ \n╚════════════════┛")
                	...
                	if msg.toType == 2:                
                           ...
                           if settings["lang"] == "JP":
                               line.inviteIntoGroup(receiver,[gcmid])
                               line.sendMessage(receiver, "พิมพ์👉  เชิญแอดมินได้ความสำเร็จของกลุ่ม ")
                           else:
                               line.inviteIntoGroup(receiver,[gcmid])
                               line.sendMessage(receiver, "😆ผู้สร้างกลุ่มอยู่ภายในแล้ว😆")
                    ...
                    line.sendMessage(msg.to, "อัปเดตกลุ่มการตอบสนองสำเร็จ : {}".format(str(settings["respMessage"])))
                    
                elif msg.text in [".เปิดตรวจสอบ"]:
                    settings["Aip"] = True
                    line.sendMessage(msg.to,"✔️เปิดระบบตรวจสอบคำหยาบกับบอทบิน  ^ω^")
                    ...
                    settings["Api"] = True
                    line.sendMessage(msg.to,"เปิดระบบApiข้อความ✔️")
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         line.sendMessage(msg.to, "ตั้งข้อความรับแอดเพื่อนเรืยบร้อย✔️")
                     else:
                         settings["message"] = spl
                         line.sendMessage(msg.to, "SELFBOT-BY:PRO\n👇ตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว ดังนี้👇\n\n👉{}".format(str(spl)))
                  ...
                  if msg._from in admin:
                    ...
                    if settings["replyPesan"] is not None:
                        ...
                        line.sendMessage(to,"โหมดสลีปของฉัน: ไม่มีการตั้งค่าข้อความ😈")
                    ...
                    try:
                        ...
                        line.sendMessage(to,"เปลี่ยนโหมดสลีปเป็น : " + text_)
                    except:
                        line.sendMessage(to,"โหมดสลีป \ n ไม่สามารถแทนที่ข้อความได้ ❎")
                  ...
                  if msg._from in admin: 
                    ...
                    if msg._from in lineMID:
                        if settings["blacklist"] == []:
                            line.sendMessage(to, "ไม่มีเจ้านาย")
                        else:
                       ...
                       for target in targets:
                           try:
                               line.inviteIntoGroup(msg.to,[target])
                               line.sendMessage(receiver, "พิมพ์👉 เชิญสำเร็จ")
                           except:
                               line.sendMessage(msg.to,"พิมพ์👉 การเชิญ")
                	...
                	if msg.toType == 2:
                         ...
                         if matched_list == []:
                             line.sendMessage(receiver,"ดำเนินการลงบัญชีหนังหมาแล้วครับ✔️")
                         else:
                    ...
                    if msg._from in Family:
                        ...
                        line.updateProfile(profile_A)
                        line.sendMessage(msg.to,"ดำเนินการอัพเดทสถานะของสเตตัสเสร็จเรียบร้อยแล้ว  👉 " + string)
...
#==============FINNISHING PROTECT========================#
                        ...
                        if settings["Wc"] == True:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความต้อนรับเมื่อมีสมาชิกเข้ากลุ่ม   ✔️")
                        else:
                            settings["Wc"] = True
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความต้อนรับเมื่อมีสมาชิกเข้ากลุ่ม   ✔️")
                        ...
                        if settings["Wc"] == False:
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"ปิดข้อความต้อนรับเมื่อมีสมาชิกเข้ากลุ่ม  ✔️ ")
                        else:
                            settings["Wc"] = False
                            if settings["lang"] == "JP":
                        ...
                        if settings["Nk"] == False:
                            ...
                            settings["Nk"] = False
                            if settings["lang"] == "JP":
                                line.sendMessage(to,"เปิดข้อความแจ้งเตือนเมื่อมีคนลบสมาชิกในกลุ่มแล้ว..✔️.")
                  ...
                  if msg._from in Family:
                    ...
                    with requests.session() as s:
                        ...
                        y += ","+ data["tags"][6]
                        y += ","+ data["tags"][7]
                        y += "\n[1]\nผู้เขียน : "+str(data["list"][0]["author"])
                        y += "\n คำ : "+str(data["list"][0]["word"])
                        y += "\nลิ้ง : "+str(data["list"][0]["permalink"])
                        y += "\nคำนิยาม : "+str(data["list"][0]["definition"])
                        y += "\nตัวอย่าง : "+str(data["list"][0]["example"])
...
#==============================================================================#
        ...
        if op.type == 1:
            if sender in Setmain["foto"]:
                ...
                line.updateProfilePicture(path)
                line.sendMessage(to,"เปลี่ยนรูปภาพสำเร็จแล้ว")
        if op.type == 25:
...
def a2():
    ...
    if nowT[14:] in ["10","20","30","40","50","60","00"]:
        return False
    else:
        return True
