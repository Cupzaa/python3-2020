...
line = LINE('ENn2FdhQhMqJKs2kWGh8.8CqiZ1VxRZhsK4NwWF8P6a.C90y5M5KLkOJ0gX/Ij69z2TuBGpBkcTZlcieCtySJ2M=')
...
settings = {
    ...
    "ksticker": False,
    "timeRestart": "18000",
    "message1":"บัญชีนี้ได้รับการป้องกันโดย\n☠️™>ທีಖএণЮ�༻ສາຢບິЊ☠️\nทางบัญชีจึงขอทำการบล็อค\n☠️เพื่อความปลอดภัยในบัญชี ☠️",
    "message":"☠️™>ທีಖএণЮ�༻ສາຢບ ິЊ☠️",
    "comment":"""  #===☠️™>ທีಖএণЮ�༻ສາຢບ ິЊ☠️===#  """,
    "userAgent": [
    ...
    "addPesan": "☠️™>ທีಖএণЮ�༻ສາຢບ ິЊ☠️",
    "addSticker": {
        "name": "",
        "status": False,
    },
    "mentionPesan": " ☠️ว่าไง ที่รัก ^_^☠️",
    "messageSticker": {
        "addName": "",
        "addStatus": False,
        "listSticker": {
...
╠❂͜͡☬➣😈ຜู้คุມกาມlทW😈 
╠❂͜͡☬➣⚡️ เฮียยิ้ม⚡️
╠❂͜͡☬➣✨ DG คาสิโน เสือมังกร
╠❂͜͡☬➣👉ไฮโล บอล
╠❂͜͡☬➣✨ สมัครเลยตอนนี้คลิ๊กเลย !
╠═════════════════════
╠❂͜͡☬➣👉http://bit.ly/2FRy7Fz
╠═════════════════════
╠❂͜͡☬➣🥰ถ้าให้แอดมินสมัครให้ส่งข้อมูล 
╠❂͜͡☬➣ 👉ชื่อ นามสกุล 
╠❂͜͡☬➣ 👉เบอร์โทรศัพท์
╠❂͜͡☬➣ 👉ธนาคาร , เลขบัญชี
╠❂͜͡☬➣ แตะลิงก์ด้านล่างเลย
╠═════════════════════
╠❂͜͡☬➣http://bit.ly/2sph6ja"
╠═════════════════════
╠❂͜͡☬➣ แตะลิงก์ด้านล่างเลย
╠═════════════════════
╠❂͜͡☬➣https://mawinbet.com/affiliate/50a7d279dfa60ed3d555107144f33506
╠═════════════════════
║            😈ຜู้คุມกาມlทW😈
╚═════════════════════
...
#==============================================================================#
                ...
                elif text.lower() == 'คำสั่ง9':
                    helpKacino= helpkacino()
                    line.sendMessage(to, str(helpKacino))
                    sendMessageWithMention(to, lineMID)
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "ดำเนินการพร้อมเริ่มระบบแล้วครับ...")
                    restartBot()
                elif text.lower() == '.ออน':
                    timeNow = time.time()
...
#😈ຜู้คุມกาມlทW😈 
                    ...
                    try:
                        ...
                        ret_ += "\n╠═════════════════════\n║  BY: SELFBOT-BY:😈ຜู้คุມกาມlทW😈\n╚═════════════════════"
                        line.sendMessage(to, str(ret_))
                        #line.sendContact(to, lineMID)
                        line.sendMessage(to, "http://bit.ly/2sph6ja")
                    except Exception as e:
                        line.sendMessage(msg.to, str(e))
...
#==============================================================================#
                    ...
                    line.sendMusic(to, line.getContact(sender).displayName, "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, str(userid), "YIM BOT", line.getContact(sender).displayName)
                    ...
                    if msg._from in admin:
                        ...
                        u.write(a)
                        u.close()
                        line.sendText(msg.to, "การสำรองข้อมูลถูกเปิดใช้งาน")
                        print (wek)
                        print (a)
                        print (r)
                        print (i)
                    ...
                    for target in targets:
                        try:
                            ...
                            line.sendMessage(msg.to, "ดำเนินการสำเร็จ...")
                        #---------------------------------------
...
#========================#
                    ...
                    line.sendText(msg.to,"WELCOME TO ROOM PRO")
...
#==============================================================================#
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        line.sendMessage(msg.to, "แต่มันไม่ได้เปิดใช้งานสิ่งที่จะรีเซ็ต?")
...
#==============================================================================#
                          ...
                          if settings["Api"] == True:
                           if msg._from in admin:
                               line.sendMessage(msg.to,"โทเคนของฉัน\n\n"+line.authToken)
...
#   
                ...
                elif ".ประกาศ2 " in msg.text:
                            text_ = removeCmd("ประกาศ2", text)
                            groups = line.getGroupIdsJoined()
                            path = sets["listpict"]
                            for group in groups:
                                line.sendMessage(group, "「 ประกาศ 」\n\n{}\n☠️™>ທีಖএণЮ☠️༻ສາຢບ ິЊ☠️".format(str(text_)))
                                line.sendImage(group, str(path))
                            line.sendMessage(to, "ส่งคำประกาศเสร็จแล้ว จำนวน {} กลุ่ม ".format(str(len(groups))))                        
                    
                elif ".ประกาศแชท " in msg.text:
                    bc = msg.text.replace(".ประกาศแชท ","")
                    gid = line.getAllContactIds()
                    for i in gid:
                        line.sendText(i,"   [ข้อความประกาศแชท]\n\n"+bc+"\n\nBy: ☠️™>ທีಖএণЮ☠️༻ສາຢບ ິЊ☠️")
                	...
                	if msg.toType == 2:                
                           ...
                           if settings["lang"] == "JP":
                               line.inviteIntoGroup(receiver,[gcmid])
                               line.sendMessage(receiver, "พิมพ์👉เชิญความสำเร็จของกลุ่ม ")
                           else:
                               line.inviteIntoGroup(receiver,[gcmid])
                  ...
                  if msg._from in admin:
                    ...
                    try:
                        ...
                        line.sendMessage(to,"โหมดสลีป \ n ไม่สามารถแทนที่ข้อความ")
...
#========================================================================
        ...
        if op.type == 26:
            ...
            if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                ...
                if settings ["Api"] == True:
            	    if msg.text in ["ป๊า","ลุง","นาย","เพื่อน","จาร์ย","อาจาร์ย","เฮีย"]:
                        line.sendMessage(msg.to, str(settings["comment"]))
                if settings ["Api"] == True:
