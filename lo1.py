...
client = LINE("sirizaa2562@gmail.com","anan2529")
...
creator = ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd','ua71776682f5f1c11ab954403203bb3ed']
adminbots = ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd','ua71776682f5f1c11ab954403203bb3ed']
...
def backupData():
    try:
        ...
        client.sendMessage("u669aa92773d33c22420105d4546fccdd",str(e))
        return False
...
def menumessage():
    if settings['setKey'] == True:
        ...
        key = ''
    menuMessage = "「 😈ຜู้คุມกาມlทW😈 ThaiLand...🇹🇭 " + "\n\n" + \
                    "•  /บอท 「 ดูเมนูคำสั่ง 」🌟" + "\n" + \
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            cmd = command(text)
                            if text.lower().startswith('# ') and sender in ['u669aa92773d33c22420105d4546fccdd']:
                            ...
                            if text.lower() == "renew" and sender in ['u669aa92773d33c22420105d4546fccdd']:
                                try:
                            ...
                            if text.lower().startswith('เพิ่ม ') and sender in sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd','ua71776682f5f1c11ab954403203bb3ed']:
                            ...
                            if text.lower().startswith('เพิ่ม1วัน ') and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 not in wait['info']:
                            ...
                            if text.lower().startswith('delsb') and sender in ['u669aa92773d33c22420105d4546fccdd']:
                                sep = text.split(" ")
                            ...
                            if text.lower().startswith('ลบ ') and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                            ...
                            if text.lower() == '/รายชื่อ' and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                            ...
                            if text.lower() == 'killall':
                                if msg._from in ['u669aa92773d33c22420105d4546fccdd']:
                                    h = ''
                                    no=0
                                    for a in wait['info']:
                                        us = wait["info"][a]
                            ...
                            if text.lower() == "ออกระบบ":
                              if sender in wait['info']:
                                ...
                                sendMention(to, ' 「 เกิดข้อผิดพลาด 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "u669aa92773d33c22420105d4546fccdd"])
                                        ...
                                        if wait["name"][us]["pay"] <= time.time():
                                            ...
                                            try:
                                                def kentod():
                                                    ...
                                                    contact = client.getContact(sender)
                                                    sendMention(to, "「「 Done! 」\nName: {}\nMid: {}\nเวลาคงเหลือ: {} วัน {} ชั่วโมง {} นาที \nSuccess login user @! \n> กรุณากดลิ้งด้านล่างด้วย(กดแค่ครั้งแรกพอ) :\line://app/1602687308-GXq4Vvk9?type=text&text=😈ຜู้คุມกาມlทW😈".format(us,sender,days,hours,minu), [sender])
                                                thread = threading.Thread(target=kentod)
                                                thread.daemon = True
                                                thread.start()
                                            except:
                            ...
                            if text.lower() == "ล็อคอินบิน":
                                ...
                                if sender in wait['info']:
                                    ...
                                    sendMention(to, ' 「 Error 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "u669aa92773d33c22420105d4546fccdd"])
                            if text.lower() == 'เพิ่มฉัน' and sender in ['u669aa92773d33c22420105d4546fccdd']:
                                try:
                            ...
                            if text.lower() == "/บายบอท" and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                client.leaveGroup(to)

                            if text.lower().startswith('ต่ออายุ ') and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if cmd == "/ออน":
                                ...
                                client.sendMessage(to, "「 😈ຜู้คุມกาມlทW😈 」\n"+str(runtime))
                                
                            if cmd == 'Jam on'and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                if xxxs["clock"] == True:
                            ...
                            if cmd == 'Jam off'and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                if xxxs["clock"] == False:
                            ...
                            if cmd == 'up'and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                if xxxs["clock"] == True:
                                    now2 = datetime.now()
                            ...
                            if cmd == 'grouplist'and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                            ...
                            if cmd.startswith('joinme '):
                              if sender in ["ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd"]:
                               text = msg.text.split()
                               number = text[1]
                               if number.isdigit():
                            ...
                            if text.lower() == "/รีบอท" and sender in ['ud68bc4235394b9406419052d4b6d5ead','u947c95f56ab1b62008c47108c6ec7615','u669aa92773d33c22420105d4546fccdd']:
                                try:
                                    sam = {'MSG_SENDER_ICON': "https://os.line.naver.jp/os/p/"+sender,'MSG_SENDER_NAME':  client.getContact(sender).displayName,}                            
                            ...
                            if cmd.startswith('invme '):
                              if sender in ["u669aa92773d33c22420105d4546fccdd"]:
                                cond = cmd.split(" ")
                                num = int(cond[1])
                            ...
                            if cmd.startswith('unsend') and sender in ["u669aa92773d33c22420105d4546fccdd"]:
                                try:
                                    args = text.split(' ')
                                    mes = 0
                                    try:
